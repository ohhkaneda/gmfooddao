...
const voteModule = sdk.getVoteModule(
  "0x0faEA6228A1D86410F46d97532164f0D96D38675",
);
...
const App = () => {
        ...
        <div>
          ...
          <div>
            ...
            >
              ...
              <small>
                Voting will trigger transactions to
                sign.
              </small>
            </form>
          </div>
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free 🐂GMfoodDAO Membership NFT</h1>
      <button
        disabled={isClaiming}
        onClick={() => {
          setIsClaiming(true);
